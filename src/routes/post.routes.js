...
const router = Router();
// POST
router.post(POST_ROUTES.create, authenticate, validateRequest(postCreateSchema), (req, res, next) =>
  postController.create(req, res, next)
);
// GET ALL POSTS
router.get(POST_ROUTES.list, (req, res, next) =>
  postController.list(req, res, next)
);
// GET POST BY ID
router.get(POST_ROUTES.details, (req, res, next) =>
